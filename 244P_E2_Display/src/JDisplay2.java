...
public class JDisplay2 implements HighLevelDisplay {
    ...
    @GuardedBy("this") private final JDisplay d;
    @GuardedBy("this") private String [] text;
    @GuardedBy("this") private int usedRows = 0;
